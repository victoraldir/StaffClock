...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    public void process(
            ...
            graphicOverlay, OnDateTimeDetected onDateTimeDetected) {
        ...
        detectInVisionImage(
                FirebaseVisionImage.fromByteBuffer(data, metadata), frameMetadata, graphicOverlay,onDateTimeDetected);
    }
...
//        detectInVisionImage(fbVisionImage, frameMetadata, graphicOverlay);
    ...
    private void detectInVisionImage(
            ...
            final OnDateTimeDetected onDateTimeDetected) {
        detectInImage(image)
                        ...
                        new OnSuccessListener<T>() {
                            ...
                            public void onSuccess(T results) {
                                ...
                                VisionProcessorBase.this.onSuccess(results, metadata,
                                        graphicOverlay, onDateTimeDetected);
                            }
                        })
