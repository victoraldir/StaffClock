...
public class CameraSource {
  ...
  private OnDateTimeDetected onDateTimeDetected;
  ...
  void setMachineLearningFrameProcessor(VisionImageProcessor processor, OnDateTimeDetected onDateTimeDetected) {
    synchronized (processorLock) {
      this.onDateTimeDetected = onDateTimeDetected;
      cleanScreen();
      if (frameProcessor != null) {
        frameProcessor.stop();
      }
